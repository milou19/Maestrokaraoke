...
import {
  getNewSongsSequenceLength,
  NewSongs,
} from "videos/UpdateVideo/NewSongs";
...
const data = {
  ...
  updates: [
    ...
    },
    {
      ...
      description: (
        <h4>
          In the <strong>options</strong>, you can block new/existing mics from
    ...
    },
    {
      title: <></>,
      description: (
        <h4>You can do the same from the remote microphone itself</h4>
      ),
    },
    {
      title: (
...
export const getUpdateVideoLength = () =>
  120 +
  getNewSongsSequenceLength(data.newSongs) -
  30 +
  getUpdatesSequenceLength(data.updates) +
  120;
    ...
    <GameScreens>
      ...
      <AbsoluteFrameProvider>
        <Series>
          ...
          <Series.Sequence
            durationInFrames={getNewSongsSequenceLength(data.newSongs)}
            offset={-30}
          >
          ...
          <Series.Sequence
            durationInFrames={getUpdatesSequenceLength(data.updates)}
            offset={-30}
          >
          ...
          <Series.Sequence durationInFrames={150} offset={-30}>
            <Scene color={"red"} id="ending">
              ...
              >
                ...
                <h1>maestrokaraoke.vercel.app</h1>
              </SAnimated>
            </Scene>
          </Series.Sequence>
