...
function ManageSongs() {
  ...
  return (
    <MenuWithLogo>
      <Helmet>
        <title>
          Manage Songs | maestrokaraoke.vercel.app - Free Online Karaoke Party
          Game
        </title>
      </Helmet>
      <h1>Manage Songs</h1>
      <SmoothLink to="exclude-languages/">
        <MenuButton
          {...register("exclude-languages", () =>
            navigate("exclude-languages/")
          )}
        >
      ...
      {setlist.isEditable && (
        <>
          <SmoothLink to="edit/list/">
            <MenuButton
              {...register("edit-songs", () => navigate("edit/list/"))}
            >
              Edit songs
            </MenuButton>
          </SmoothLink>
          <SmoothLink to="edit/setlists">
            <MenuButton
              {...register("edit-setlists", () => navigate("edit/setlists"))}
            >
              Manage setlists
            </MenuButton>
          </SmoothLink>
          <SmoothLink to="convert/">
            <MenuButton
              {...register("convert-song", () => navigate("convert/"))}
            >
