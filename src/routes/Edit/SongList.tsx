            ...
            <Grid item xs={12}>
              <SongsTable
                ...
                renderRowActions={({ row }) => (
                  <>
                    <Link
                      to={buildUrl(`edit/song/`, {
                        song: row.original.id,
                        id: null,
                      })}
                    >
                      <IconButton
                    ...
                    <IconButton
                      ...
                      onClick={async () => {
                        ...
                        anchor.href = `data:plain/text;charset=utf-8,${encodeURIComponent(
                          txt
                        )}`;
                        anchor.download = `${SongDao.generateSongFile(
                          songData
                        )}.txt`;
                    ...
                    <IconButton
                      className={
                        !row.original.local ? "cursor-default! opacity-50" : ""
                      }
                      ...
                      onClick={async () => {
                        ...
                        if (proceed) {
                          ...
                          if (
                            shareSongs &&
                            data.some((song) => song.id === row.original.id)
                          ) {
                            posthog.capture("unshare-song", {
