...
function LandingPage() {
  ...
  return (
    <>
      <Helmet>
        <title>
          maestrokaraoke.vercel.app - Free Online Karaoke Party Game
        </title>
      </Helmet>
      <GithubRibbon />
        ...
        <Box className="mobile:flex-col landscap:flex-1 flex-row gap-24 bg-black/75 p-24 [&_hr]:my-12">
          <StatSegment>
            <div className="text-justify leading-normal">
              <strong>AllKaraoke</strong> is a free online karaoke game inspired
              by PlayStation&#39;s <strong>SingStar</strong>. Sing along to your
              favorite songs and compete with your friends, all through the
              browser! Updated almost weekly with new songs and features.
            </div>
            <hr />
            <StatText>
          ...
          <StatSegment className="mobile:flex-row landscap:hidden gap-16">
            ...
            <Screenshot
              src={screenshot2}
              alt="In-game screen"
              className="[box-shadow:_0_0_10rem_rgb(19,19,19)]"
            />
          </StatSegment>
        </Box>
...
const PlayButton = twc(
  ButtonLink
)`text-[9rem] bg-black w-full px-28 py-4 animate-focused`;
