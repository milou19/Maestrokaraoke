...
Every pull request is being deployed to a separate folder on maestrokaraoke.vercel.app on push. There are few quirks around it
...
The link to the deployed version is `https://maestrokaraoke.vercel.app/prs/{pr-number}/`.